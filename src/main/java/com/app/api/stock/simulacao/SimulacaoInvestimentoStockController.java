...
@RestController
@RequestMapping("/simula-investimento-stock")
@Tag(name = "Stock - Simulação Investimento")
public class SimulacaoInvestimentoStockController implements BaseSimulacaoInvestimentoController {

    @Autowired
    SimulaInvestimentoStockService service;
    ...
    @CrossOrigin
    @PostMapping
    @Operation(summary = "Registra ou atualiza informações da Simulação de Investimento de Stocks")
    ...
    @Operation(summary = "Remove registro da Simulação de Investimento de Stocks")
