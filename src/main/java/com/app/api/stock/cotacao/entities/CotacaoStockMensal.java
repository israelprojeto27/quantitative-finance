...
@Data
@Entity
@Table(name = "cotacao_stock_mensal")
public class CotacaoStockMensal {
    @Id
    ...
    public static CotacaoStockMensal toEntity(String[] array, Stock stock) {
        try{
            return CotacaoStockMensal.builder()
