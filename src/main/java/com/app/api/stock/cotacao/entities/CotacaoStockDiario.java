...
@Data
@Entity
@Table(name = "cotacao_stock_diario")
public class CotacaoStockDiario {
    ...
    public static CotacaoStockDiario toEntity(String[] array, Stock stock) {
        try{
            return CotacaoStockDiario.builder()
