...
@RestController
@RequestMapping("/analise-stock")
@Tag(name = "Stock - Análises")
public class StockAnaliseController implements BaseAtivoAnaliseController {

    @Autowired
    StockAnaliseService service;

    @Override
    @GetMapping
    @Operation(summary = "Recupera todos as Stock cadastradas na lista de análises")
    ...
    @Override
    @DeleteMapping("/{sigla}")
    @Operation(summary = "Remove stock da lista de analises")
    ...
    @Override
    @GetMapping("/filter")
    @Operation(summary = "Filtra e recupera todos as stocks cadastradas na lista de análises")
    ...
    @Operation(summary = "Gerar mapa de dividendos entre datas específicas das stock contidas na lista de analises")
    ...
    @Operation(summary = "Soma os percentuais de cotações das stocks que estão na lista de análises")
