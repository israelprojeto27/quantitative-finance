...
@RestController
@RequestMapping("/dividendo-stock")
@Tag(name = "Stock - Dividendo")
public class DividendoStockController implements BaseDividendoController<DividendoStockDTO, StockListDividendoDTO> {
    ...
    public ResponseEntity<List<DividendoStockDTO>> findDividendoBySigla(@PathVariable String sigla) {
    ...
    public ResponseEntity<List<StockListDividendoDTO>> filterDividendosByPeriod(@RequestBody FilterPeriodDTO dto) {
    ...
    @Operation(summary = "Calcula o rendimento em dividendos de uma Stock a partir do Id e a quantidade de cotas informados",
              description = "Deverá ser exibido a Sigla da idStock, Data, o Valor Rendimento em dividendos, Cotação da Stock, Valor Dividendo" )
    public ResponseEntity<SumCalculateYieldDividendosAtivoDTO> calculateYieldByIdAtivoByQuantCotas(@PathVariable Long idStock, @PathVariable Long quantidadeCotas) {
