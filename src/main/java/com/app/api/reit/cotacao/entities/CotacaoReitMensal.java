...
@Data
@Entity
@Table(name = "cotacao_reit_mensal")
public class CotacaoReitMensal {
    @Id
    ...
    public static CotacaoReitMensal toEntity(String[] array, Reit reit) {
        try{
            return CotacaoReitMensal.builder()
