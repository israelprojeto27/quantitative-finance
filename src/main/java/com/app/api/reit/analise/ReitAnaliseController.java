...
@RestController
@RequestMapping("/analise-reit")
@Tag(name = "Reit - Análises")
public class ReitAnaliseController implements BaseAtivoAnaliseController {

    @Autowired
    ReitAnaliseService service;


    @Override
    @GetMapping
    @Operation(summary = "Recupera todos as Reits cadastradas na lista de análises")
    ...
    @CrossOrigin
    @Override
    @PostMapping("/add-reit/{sigla}")
    @Operation(summary = "Adiçiona a reit para a lista de analises")
    ...
    @Override
    @DeleteMapping("/{sigla}")
    @Operation(summary = "Remove reit da lista de analises")
    ...
    @Override
    @GetMapping("/filter")
    @Operation(summary = "Filtra e recupera todos as reits cadastradas na lista de análises")
    ...
    @Operation(summary = "Gerar mapa de dividendos entre datas específicas das reit contidas na lista de analises")
    ...
    @Operation(summary = "Soma os percentuais de cotações das reits que estão na lista de análises")
