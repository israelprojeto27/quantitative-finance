...
public class BdrAnaliseController implements BaseAtivoAnaliseController {
    ...
    @Override
    @GetMapping("/filter")
    @Operation(summary = "Filtra e recupera todos os BDRs cadastrados na lista de análises")
    ...
    @Operation(summary = "Gerar mapa de dividendos entre datas específicas dos bdrs contidas na lista de analises")
    ...
    @Operation(summary = "Soma os percentuais de cotações dos BDRs que estão na lista de análises")
