...
@Data
@Entity
@Table(name = "cotacao_bdr_mensal")
public class CotacaoBdrMensal {
    ...
    public CotacaoBdrMensal() {
    }

    public CotacaoBdrMensal(Long id, LocalDate data, Double high, Double low, Double open, Double close, Double adjclose, Long volume, Timestamp createdAt, Timestamp updatedAt, Bdr bdr) {
        this.id = id;
        this.data = data;
        this.high = high;
        this.low = low;
