...
public class CotacaoAcaoSemanal {
    ...
    public CotacaoAcaoSemanal() {
    }

    public CotacaoAcaoSemanal(Long id, LocalDate data, Double high, Double low, Double open, Double close, Double adjclose, Long volume, Timestamp createdAt, Timestamp updatedAt, Acao acao) {
        this.id = id;
        this.data = data;
        this.high = high;
        this.low = low;
