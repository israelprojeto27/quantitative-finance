...
public class CotacaoFundoController implements BaseCotacaoController<FundoCotacaoDTO> {
    ...
    @Override
    @Operation(summary = "Recupera em todos os periodos (diario, semanal, mensal) todas as cotações de um Fundo Imobilario pelo o seu Id")
    ...
    @Override
    @Operation(summary = "Recupera em um período específico (diario, semanal, mensal) todas as cotações de um Fundo Imobiliario pelo o seu Id")
    ...
    @Override
    @Operation(summary = "Recupera em todos os periodos (diario, semanal, mensal) todas as cotações de um Fundo Imobiliario pela sua Sigla")
    ...
    @Override
    @Operation(summary = "Recupera em um período específico (diario, semanal, mensal) todas as cotações de um Fundo Imobiliario pela sua Sigla")
