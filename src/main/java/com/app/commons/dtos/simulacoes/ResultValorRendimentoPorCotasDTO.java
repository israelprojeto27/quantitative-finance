...
public class ResultValorRendimentoPorCotasDTO {
    ...
    public ResultValorRendimentoPorCotasDTO() {
    }

    public ResultValorRendimentoPorCotasDTO(String sigla, Double valorRendimento, String valorRendimentoFmt, Double quantidadeCotas, String quantidadeCotasFmt, Double valorUltimaCotacao, LocalDate dataUltimaCotacao, Double valorUltimoDividendo, LocalDate dataUltimoDividendo, String valorUltimaCotacaoFmt, String dataUltimaCotacaoFmt, String valorUltimoDividendoFmt, String dataUltimoDividendoFmt) {
        this.sigla = sigla;
